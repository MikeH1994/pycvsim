...
camera_1 = SceneCamera.create_camera_from_lookpos(pos=np.array([0.0, 0.0, -2.5]), lookpos=np.array([0.0, 0.0, 0.0]),
                                                  up=np.array([0.0, 1.0, 0.0]), res=(1001, 1001), hfov=35.0)
camera_2 = SceneCamera.create_camera_from_lookpos(pos=np.array([-0.3, 0.0, -2.5]), lookpos=np.array([0.0, 0.0, 0.0]),
                                                  up=np.array([0.0, 1.0, 0.0]), res=(1001, 1001), hfov=35.0)
