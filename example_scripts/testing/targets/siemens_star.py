...
res = (720, 640)
mesh = SiemensStar(radius=0.5, n_spokes=72)
...
while True:
    for theta in np.linspace(-180, 180, 100):
        ...
        image_points = renderer.cameras[0].get_pixel_point_lies_in(mesh.get_object_points())
        img_1 = renderer.render(0, n_samples=10**2)
