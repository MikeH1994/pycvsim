...
img_1 = o3d_renderer.render_image(0, background_colour=(51, 51, 51), n_samples=1)
img_2 = panda3d_renderer.render_image(0, n_samples=0, antialiasing=panda3d.core.AntialiasAttrib.MNone)
