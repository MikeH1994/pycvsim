...
mesh = CheckerboardTarget((9, 8), (0.05, 0.05), board_thickness=0.02, color_bkg=(128, 0, 0), board_boundary=0.05)

noise_model = NoiseModel(image_size=(1024, 1600), preset="default")
cameras = [VirtualCamera(pos=np.array([0.0, 0.0, -1.5]), res=(1600, 1024), hfov=30.0, noise_model=noise_model)]
